...
public class ResourceController extends BaseController {
    ...
    @PostMapping("getAuthResourceList")
    public ResultObject getResourceList(HttpServletRequest request){
        log.info("params: ");
        ResultObject result;
        try{

            UserInfoBean userInfo =  UserInfoTool.getUserInfo(request);
            List list = resourceInfoService.getResourceListAccountId(userInfo.getId());
